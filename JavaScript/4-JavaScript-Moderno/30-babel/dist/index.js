...
var average = function average() {
  ...
  //Somando todos os números de dentro do "Array"
  var sum = numbers.reduce(function (accum, num) {
    return accum + num;
  }, 0);
  return sum / numbers.length;
};
console.log("M\xE9dia Aritm\xE9tica simples: ".concat(average(10, 9, 8, 7)));
var weightedAverage = function weightedAverage() {
  ...
  //Somando todos os números de dentro do "Array", e multiplicando pelo seu peso
  var sum = entries.reduce(function (accum, _ref) {
    var number = _ref.number,
      weight = _ref.weight;
    return accum + number * (weight !== null && weight !== void 0 ? weight : 1);
  }, 0);
  //Somando todos os pesos do "Array"
...
var median = function median() {
  ...
  var firstMedian = orderNumbers[middle - 1];
  var secondMedian = orderNumbers[middle];
